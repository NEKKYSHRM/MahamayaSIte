    ...
    <div className="w-full items-start grid grid-cols-[25%_50%_25%] place-items-center bg-white box-border">
      ...
      <div className="w-full px-6 py-10 flex flex-col gap-7 justify-center">
        <div className="w-full flex flex-col justify-center items-center">
          ...
          <p className="text-gray-700 font-bold mt-3 text-center font-serif text-sm">B. Tech. (Renewable Energy Engineering)</p>
          <p className="text-gray-700 font-bold mt-3 text-center font-serif text-sm">M. Tech. (Renewable Energy Engineering)</p>
